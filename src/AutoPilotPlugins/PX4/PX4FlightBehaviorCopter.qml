        ...
        Column {
            ...
            Column {
                ...
                QGCCheckBox {
                    ...
                    checked:            _sys_vehicle_resp ? (_sys_vehicle_resp.value >= 0) : false
                    onClicked: {
                        if (checked) {
                ...
                QGCLabel {
                    visible:            _sys_vehicle_resp ? (_sys_vehicle_resp.value > 0.8) : false
            ...
            Column {
                ...
                QGCCheckBox {
                    ...
                    checked:            _mpc_z_vel_all ? (_mpc_z_vel_all.value >= 0) : false
                    onClicked: {
                        if (checked) {
